...
export declare const defaultExts: string[];
export declare const defaultEntries: string[];
/**
...
export declare function loadServerEntry(opts: LoadOptions): Promise<LoadedServerEntry>;
