import { Driver, DriverDependencies, DriverDependency, DriverFlags, GetKeysOptions, Storage, StorageMeta, StorageValue, TransactionOptions, Unwatch, WatchCallback, WatchEvent } from "./_chunks/types.mjs";
...
import { CacheOptions } from "unstorage/drivers/cloudflare-cache-binding";
...
type BuiltinDriverOptions = {
  ...
  "cloudflare-cache-binding": CacheOptions;
  "cloudflareCacheBinding": CacheOptions;
...
declare const builtinDrivers: {
  ...
  readonly "cloudflare-cache-binding": "unstorage/drivers/cloudflare-cache-binding";
  readonly cloudflareCacheBinding: "unstorage/drivers/cloudflare-cache-binding";
 ...
 */
declare const builtinDriverDependencies: Partial<Record<BuiltinDriverName, DriverDependencies>>;
export { type BuiltinDriverName, type BuiltinDriverOptions, CreateStorageOptions, Driver, DriverDependencies, DriverDependency, DriverFlags, GetKeysOptions, Snapshot, Storage, StorageMeta, StorageValue, TransactionOptions, Unwatch, WatchCallback, WatchEvent, builtinDriverDependencies, builtinDrivers, createStorage, filterKeyByBase, filterKeyByDepth, joinKeys, normalizeBaseKey, normalizeKey, prefixStorage, restoreSnapshot, snapshot };