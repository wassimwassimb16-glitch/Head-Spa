...
export const Route = createFileRoute("/pred-navstevou")({
  head: () => ({
    meta: [
      { title: "Před návštěvou | Head Spa By Kratochvílová" },
      {
        name: "description",
        content:
          "Praktické informace před rituálem v Head Spa By Kratochvílová v Hradci Králové.",
      },
      {
        property: "og:title",
        content: "Před návštěvou | Head Spa By Kratochvílová",
      },
      {
        property: "og:description",
        content: "Připravte se na svůj rituál v Head Spa By Kratochvílová.",
      },
      ...
      <main className="mx-auto max-w-4xl px-6 pb-24 md:px-10">
        ...
        <div className="space-y-8 text-lg leading-8 text-muted-foreground">
          ...
          {t.before.blocks.map((block) => (
            <section
              key={block.title}
              className="border-l-2 border-copper pl-6"
            >
